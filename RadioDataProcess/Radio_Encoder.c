/*
#include <radiodata/AX5043.h>
#include <radiodata/Radio_Common.h>
#include <radiodata/Radio_Encoder.h>
...
void Handshake(void)
{
    RadioSend_T(20000209,1,2,0);
}
MSH_CMD_EXPORT(Handshake,Handshake);


void RadioSend_T(uint32_t Taget_Id, uint8_t counter, uint8_t Command, uint8_t Data)
{
    ...
    sprintf(buf, "!{%08ld,%08ld,%03d,%02d,%d}", Self_Id_T, Taget_Id, counter, Command, Data);
